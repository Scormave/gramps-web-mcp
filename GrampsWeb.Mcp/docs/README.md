...
|----------|----------|-------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | Contributors | System design, layers, transport modes, deployment |
| [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md) | Contributors | How to add tools, models, tests, and conventions |
| [TOOL_CATALOG.md](TOOL_CATALOG.md) | Users and agents | Complete catalog of 55 MCP tools, resources, and prompts |
